...
public class TC_01Create_Reservations extends BaseTestScript {
	...
	public void loginMethod() throws Exception {
		...
		Log.info("TC_01 Create_Reservations");
		...
		createReservationsObjectPg.clickCreateRoom();
		createReservationsObjectPg.clickMealPlanCheckBox();
		createReservationsObjectPg.clickBook();
		createReservationsObjectPg.clickSave();
		homePg = createReservationsObjectPg.clickClose();
