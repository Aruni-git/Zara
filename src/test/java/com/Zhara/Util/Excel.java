...
public class Excel {
	...
	public static void setExcelFile(String Path, String DataExcel) throws Exception {
		...
		try {
			...
			ExcelWSheet = ExcelWBook.getSheet(DataExcel);
	...
	// This method is to read integer inputs cell data from the excel
